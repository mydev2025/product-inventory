...
return [
    ...
    */
    ...
    'alpha_dash' => ':attributeには、英数字(\'A-Z\',\'a-z\',\'0-9\')とハイフンとアンダースコア(\'-\',\'_\')が使用できます。',
    ...
    'prohibits' => ':attributeフィールドが存在している場合、:otherは禁止されています。',
    'regex' => ':attributeの形式が無効です。',
    'required' => ':attributeは必須項目です。',
    'required_array_keys' => ':attributeフィールドには:valuesのエントリが必要です。',
    'required_if' => ':otherが:valueの場合、:attributeを指定してください。',
    'required_unless' => ':otherが:valuesに含まれていない場合、:attributeを指定してください。',
    'required_with' => ':valuesが指定されている場合、:attributeも指定してください。',
    'required_with_all' => ':valuesが指定されている場合、:attributeも指定してください。',
